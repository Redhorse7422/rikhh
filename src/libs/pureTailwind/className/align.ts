...
export const TW_CLS_ALIGN_CONTENT_SCREEN: TwScreenStyle<TwAlignContent> = {
  default: {
    start: 'content-start',
    end: 'content-end',
...
export const TW_CLS_ALIGN_ITEMS_SCREEN: TwScreenStyle<TwAlignItems> = {
  default: {
    start: 'items-start',
    end: 'items-end',
    center: 'items-center',
...
export const TW_CLS_ALIGN_SELF_SCREEN: TwScreenStyle<TwAlignSelf> = {
  default: {
    start: 'self-start',
    end: 'self-end',
    center: 'self-center',
