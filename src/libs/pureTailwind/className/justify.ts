...
export const TW_CLS_JUSTIFY_CONTENT_SCREEN: TwScreenStyle<TwJustifyContent> = {
  default: {
    start: 'justify-start',
    end: 'justify-end',
...
export const TW_CLS_JUSTIFY_ITEMS_SCREEN: TwScreenStyle<TwJustifyItems> = {
  default: {
...
export const TW_CLS_JUSTIFY_SELF_SCREEN: TwScreenStyle<TwJustifySelf> = {
  default: {
