...
export function ChevronLeft(props: PropsType) {
  return (
    <svg width={8} height={16} viewBox='0 0 8 16' fill='currentColor' {...props}>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M.728 8.447a.687.687 0 010-.895l5.5-6.416a.688.688 0 011.044.895L2.155 8l5.117 5.97a.688.688 0 01-1.044.894l-5.5-6.417z'
      />
    </svg>
  )
}
  ...
  return (
    <svg width={8} height={16} viewBox='0 0 8 16' fill='currentColor' {...props}>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
        d='M7.272 7.553a.687.687 0 010 .895l-5.5 6.416a.688.688 0 01-1.044-.895L5.845 8 .728 2.03A.688.688 0 011.772 1.136l5.5 6.417z'
      />
    </svg>
  )
}
