...
export const RikhhAccountDelete: React.FC = () => {
  return (
    <div className='min-h-screen bg-gray-50 py-12'>
      <div className='mx-auto max-w-4xl px-4 sm:px-6 lg:px-8'>
        {/* Header */}
        <div className='mb-12 text-center'>
          <h1 className='mb-4 text-4xl font-bold text-gray-900'>Rikhh Account Delete</h1>
          <p className='text-lg text-gray-600'>
            Follow the steps below to delete your Rikhh account. Your account will be permanently deleted after 30 days
        ...
        <div className='rounded-lg bg-white p-8 shadow-sm'>
          ...
          <div className='mb-8 border-b border-gray-200 pb-6'>
            <h2 className='mb-2 text-2xl font-bold text-gray-900'>Step by step process to delete your Rikhh account</h2>
          </div>
                ...
                <div>
                  ...
                  <ul className='space-y-2 text-gray-700'>
                    <li className='flex items-start'>
                      ...
                      <span>Open the Rikhh app on your device</span>
                    </li>
                    <li className='flex items-start'>
                      <Icon name='AiOutlineCheck' className='mr-2 mt-0.5 h-5 w-5 flex-shrink-0 text-green-500' />
